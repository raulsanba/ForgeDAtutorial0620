    ...
    public class DesignAutomationController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateActivity([FromBody] JObject activitySpecs)
        {
            ...
            if (!activities.Data.Contains(qualifiedActivityId))
            {
                ...
                //specify Alias for this activity
        ...
        public async Task<IActionResult> StartWorkitem([FromForm] StartWorkitemInput input)
        {
            ...
            //Upload input file
            string inputFileNameOSS = string.Format("{0}_input_{1}", DateTime.Now.ToString("yyyyMMddhhmmss"), Path.GetFileName(input.inputFile.FileName));
            ...
            //the callback contains the connectionId (for identifing the client) and the outputfilename of this workitem
